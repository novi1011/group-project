<section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        @endif
        @if(auth()->user()->role == 'admin')
        <li class="menu-sidebar"><a href="{{ url('/supplier/index') }}"><span class="fa fa-meh-o"></span> Lihat List Supplier</span></a></li>
        @endif
        @if(auth()->user()->role == 'admin')
        <li class="menu-sidebar"><a href="{{ url('/produk/index') }}"><span class="fa fa-table"></span> Lihat List Produk</span></a></li>
        @endif
        @if(auth()->user()->role == 'admin')
        <li class="menu-sidebar"><a href="{{ url('/po/index') }}"><span class="fa fa-shopping-cart"></span> Lihat List Pesan produk</span></a></li>
        @endif
        @if(auth()->user()->role == 'admin')
